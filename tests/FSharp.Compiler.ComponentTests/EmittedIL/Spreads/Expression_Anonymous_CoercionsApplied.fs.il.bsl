       ...
       extends [runtime]System.Object
{
  ...
  .custom instance void [runtime]System.Diagnostics.DebuggerBrowsableAttribute::.ctor(valuetype [runtime]System.Diagnostics.DebuggerBrowsableState) = ( 01 00 00 00 00 00 00 00 ) 
  .field static assembly class '<>f__AnonymousType2396826819`1'<class assembly/U> r9@14
  .custom instance void [runtime]System.Diagnostics.DebuggerBrowsableAttribute::.ctor(valuetype [runtime]System.Diagnostics.DebuggerBrowsableState) = ( 01 00 00 00 00 00 00 00 ) 
  .field static assembly class assembly/T '_arg1@4-1'
  .custom instance void [runtime]System.Diagnostics.DebuggerBrowsableAttribute::.ctor(valuetype [runtime]System.Diagnostics.DebuggerBrowsableState) = ( 01 00 00 00 00 00 00 00 ) 
  ...
  .method public specialname static class '<>f__AnonymousType2396826819`1'<class assembly/U> get_r9() cil managed
  {
    
    .maxstack  8
    IL_0000:  ldsfld     class '<>f__AnonymousType2396826819`1'<class assembly/U> assembly::r9@14
    IL_0005:  ret
  } 

  .method assembly specialname static class assembly/T 'get__arg1@4-1'() cil managed
  {
    
    .maxstack  8
    IL_0000:  ldsfld     class assembly/T assembly::'_arg1@4-1'
    IL_0005:  ret
  } 
  ...
  .method assembly specialname static void staticInitialization@() cil managed
  {
    ...
    IL_0048:  nop
    IL_0049:  call       class '<>f__AnonymousType2396826819`1'<class assembly/T> assembly::get_r6()
    IL_004e:  call       instance !0 class '<>f__AnonymousType2396826819`1'<class assembly/T>::get_A()
    IL_0053:  stsfld     class assembly/T assembly::'_arg1@4-1'
    IL_0058:  call       class assembly/T assembly::'get__arg1@4-1'()
    IL_005d:  ldfld      int32 assembly/T::item
    IL_0062:  newobj     instance void assembly/U::.ctor(int32)
    IL_0067:  newobj     instance void class '<>f__AnonymousType2396826819`1'<class assembly/U>::.ctor(!0)
    IL_006c:  stsfld     class '<>f__AnonymousType2396826819`1'<class assembly/U> assembly::r9@14
    IL_0071:  ret
  } 
  ...
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 09 00 00 00 00 00 ) 
    .get class '<>f__AnonymousType2396826819`1'<class assembly/U> assembly::get_r9()
  } 
  .property class assembly/T
          '_arg1@4-1'()
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 09 00 00 00 00 00 ) 
    .get class assembly/T assembly::'get__arg1@4-1'()
  } 
} 
...
.class public auto ansi serializable sealed beforefieldinit '<>f__AnonymousType3670812594`0'
       extends [runtime]System.Object
       implements [runtime]System.Collections.IStructuralComparable,
                  [runtime]System.IComparable,
                  class [runtime]System.IComparable`1<class '<>f__AnonymousType3670812594`0'>,
                  [runtime]System.Collections.IStructuralEquatable,
                  class [runtime]System.IEquatable`1<class '<>f__AnonymousType3670812594`0'>
{
  .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
  ...
  .method public specialname rtspecialname instance void  .ctor() cil managed
  {
    .custom instance void [runtime]System.Diagnostics.CodeAnalysis.DynamicDependencyAttribute::.ctor(valuetype [runtime]System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes,
                                                                                                            class [runtime]System.Type) = ( 01 00 60 06 00 00 1E 3C 3E 66 5F 5F 41 6E 6F 6E   
                                                                                                                                                   79 6D 6F 75 73 54 79 70 65 33 36 37 30 38 31 32   
                                                                                                                                                   35 39 34 60 30 00 00 )                            
  ...
  .method public strict virtual instance string ToString() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldstr      "%+A"
    IL_0005:  newobj     instance void class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`5<class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class '<>f__AnonymousType3670812594`0',string>,class [FSharp.Core]Microsoft.FSharp.Core.Unit,string,string,class '<>f__AnonymousType3670812594`0'>::.ctor(string)
    IL_000a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.ExtraTopLevelOperators::PrintFormatToString<class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class '<>f__AnonymousType3670812594`0',string>>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [FSharp.Core]Microsoft.FSharp.Core.Unit,string,string>)
    IL_000f:  ldarg.0
    IL_0010:  callvirt   instance !1 class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class '<>f__AnonymousType3670812594`0',string>::Invoke(!0)
    IL_0015:  ret
  } 

  .method public hidebysig virtual final instance int32  CompareTo(class '<>f__AnonymousType3670812594`0' obj) cil managed
  {
    .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
  ...
  .method public hidebysig virtual final instance int32  CompareTo(object obj) cil managed
  {
    ...
    IL_0000:  ldarg.0
    IL_0001:  ldarg.1
    IL_0002:  unbox.any  '<>f__AnonymousType3670812594`0'
    IL_0007:  tail.
    IL_0009:  callvirt   instance int32 '<>f__AnonymousType3670812594`0'::CompareTo(class '<>f__AnonymousType3670812594`0')
    IL_000e:  ret
  } 
  ...
  .method public hidebysig virtual final instance int32  CompareTo(object obj, class [runtime]System.Collections.IComparer comp) cil managed
  {
    ...
    .maxstack  3
    .locals init (class '<>f__AnonymousType3670812594`0' V_0,
             class '<>f__AnonymousType3670812594`0' V_1)
    IL_0000:  ldarg.1
    IL_0001:  unbox.any  '<>f__AnonymousType3670812594`0'
    IL_0006:  stloc.0
    IL_0007:  ldloc.0
    IL_0008:  stloc.1
    IL_0009:  ldarg.0
    ...
    IL_000c:  ldarg.1
    IL_000d:  unbox.any  '<>f__AnonymousType3670812594`0'
    ...
    IL_0018:  ldarg.1
    IL_0019:  unbox.any  '<>f__AnonymousType3670812594`0'
  ...
  .method public hidebysig virtual final instance int32  GetHashCode() cil managed
  {
    ...
    IL_0006:  tail.
    IL_0008:  callvirt   instance int32 '<>f__AnonymousType3670812594`0'::GetHashCode(class [runtime]System.Collections.IEqualityComparer)
    IL_000d:  ret
  } 

  .method public hidebysig instance bool Equals(class '<>f__AnonymousType3670812594`0' obj, class [runtime]System.Collections.IEqualityComparer comp) cil managed
  {
    .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
  ...
  .method public hidebysig virtual final instance bool  Equals(object obj, class [runtime]System.Collections.IEqualityComparer comp) cil managed
  {
    ...
    .locals init (class '<>f__AnonymousType3670812594`0' V_0)
    IL_0000:  ldarg.1
    IL_0001:  isinst     '<>f__AnonymousType3670812594`0'
    IL_0006:  stloc.0
    IL_0007:  ldloc.0
    ...
    IL_000c:  ldarg.2
    IL_000d:  tail.
    IL_000f:  callvirt   instance bool '<>f__AnonymousType3670812594`0'::Equals(class '<>f__AnonymousType3670812594`0',
  ...
  .method public hidebysig virtual final instance bool  Equals(class '<>f__AnonymousType3670812594`0' obj) cil managed
  {
    .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
  ...
  .method public hidebysig virtual final instance bool  Equals(object obj) cil managed
  {
    ...
    IL_000b:  ldloc.0
    IL_000c:  tail.
    IL_000e:  callvirt   instance bool '<>f__AnonymousType3670812594`0'::Equals(class '<>f__AnonymousType3670812594`0')
    IL_0013:  ret
