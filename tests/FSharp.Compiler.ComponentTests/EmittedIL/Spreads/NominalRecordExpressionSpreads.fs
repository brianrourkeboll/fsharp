...
[<Theory; FileInlineData("Expression_Nominal_CoercionsApplied.fs", Realsig = BooleanOptions.True, Optimize = BooleanOptions.True)>]
let Expression_Nominal_CoercionsApplied_fs compilation =
    compilation
    |> getCompilation
    |> verifyCompilation
