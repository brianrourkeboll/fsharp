        ...
        module NonRecordSource =
            ...
            let ``{...class} → error`` () =
                ...
                |> withDiagnostics [
                    ...
                    Error 3881, Line 7, Col 46, Line 7, Col 50, "The source expression of a spread into an anonymous record expression must have a nominal or anonymous record type."
                ]
            ...
            let ``{...abstract_class} → error`` () =
                ...
                |> withDiagnostics [
                    ...
                    Error 3881, Line 19, Col 37, Line 21, Col 57, "The source expression of a spread into an anonymous record expression must have a nominal or anonymous record type."
                ]
            ...
            let ``{...struct} → error`` () =
                ...
                |> withDiagnostics [
                    ...
                    Error 3881, Line 8, Col 46, Line 8, Col 50, "The source expression of a spread into an anonymous record expression must have a nominal or anonymous record type."
                ]
            ...
            let ``{...interface} → error`` () =
                ...
                |> withDiagnostics [
                    ...
                    Error 3881, Line 18, Col 37, Line 20, Col 57, "The source expression of a spread into an anonymous record expression must have a nominal or anonymous record type."
                ]
            ...
            let ``{...int} → error`` () =
                ...
                |> withDiagnostics [
                    ...
                    Error 3881, Line 3, Col 46, Line 3, Col 47, "The source expression of a spread into an anonymous record expression must have a nominal or anonymous record type."
                ]
            ...
            let ``{...(int -> int)} → error`` () =
                ...
                |> withDiagnostics [
                    ...
                    Error 3881, Line 3, Col 46, Line 3, Col 62, "The source expression of a spread into an anonymous record expression must have a nominal or anonymous record type."
                ]
            ...
            let ``{...int list} → error`` () =
                ...
                |> withDiagnostics [
                    ...
                    Error 3881, Line 3, Col 46, Line 3, Col 53, "The source expression of a spread into an anonymous record expression must have a nominal or anonymous record type."
                ]
