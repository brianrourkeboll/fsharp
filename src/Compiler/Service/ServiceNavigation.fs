                    ...
                    let fields =
                        [
                            for fieldOrSpread in fieldsAndSpreads do
                                ...
                                | SynFieldOrSpread.Field (SynField(idOpt = Some ident; range = m)) -> yield createMember (ident, NavigationItemKind.Field, FSharpGlyph.Field, m, NavigationEntityKind.Record, false, access)
