    ...
    [
        ...
        | SynTypeDefnRepr.Simple(simpleRepr, _) ->
            ...
            | SynTypeDefnSimpleRepr.Record(recordFieldsAndSpreads = fieldsAndSpreads) ->
                yield! List.collect (function SynFieldOrSpread.Field field -> visitSynField field | SynFieldOrSpread.Spread spread -> visitSynTypeSpread  spread) fieldsAndSpreads
